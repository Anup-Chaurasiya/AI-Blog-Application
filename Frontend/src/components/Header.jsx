    ...
    <div className="mx-8 sm:mx-16 xl:mx-24 relative">
      <div className="text-center mt-20 mb-8">
        <div
          ...
          mb-4 border border-primary/40 bg-primary/10 
      ...
      <div className='text-center'>
        {input && <button onClick={onClear} className='border border-primary text-primary rounded-full cursor-pointer px-4 py-2 hover:bg-primary hover:text-white transition-all'>
          Clear Search
        </button>}
      </div>
